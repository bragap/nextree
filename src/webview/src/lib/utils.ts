import { NODE_HEIGHT, NODE_WIDTH, TreeEdge, TreeNode } from "./constants";
import { Node, Edge, MarkerType } from "@xyflow/react";
import Dagre from '@dagrejs/dagre';

export const getNodeBackground = (n: TreeNode) => {
...
export const toReactFlowNode = (treeNode: TreeNode[]): Node[] => {
...
export const toReactFlowEdge = (treeEdge: TreeEdge[]): Edge[] => {
